...
public class MealTestData {
    ...
    public static final Meal adminMeal3 = new Meal(ADMIN_MEAL_ID + 2, of(2021, Month.NOVEMBER, 4, 12, 4), "Админ попил чаек", 100);

    public static final List<Meal> meals = Arrays.asList(meal7, meal6, meal5, meal4, meal3, meal2, meal1);

    public static Meal getNew() {
        return new Meal(null, of(2021, Month.NOVEMBER, 23, 13, 16), "Созданный обед", 300);
    }
