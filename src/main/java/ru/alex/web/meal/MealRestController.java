...
import ru.alex.service.MealService;
import ru.alex.to.MealTo;
import ru.alex.util.UserMealsUtil;
import ru.alex.web.SecurityUtil;
...
public class MealRestController {
    ...
    public List<MealTo> getAll() {
        ...
        return UserMealsUtil.getTos(service.getAll(userId), SecurityUtil.authUserCaloriesPerDay());
    }
    ...
    public List<MealTo> getBetween(@Nullable LocalDate startDate, @Nullable LocalTime startTime,
        ...
        return UserMealsUtil.getFilteredTos(mealsDateFiltered, SecurityUtil.authUserCaloriesPerDay(), startTime, endTime);
    }
}
